    ...
    <div ref={rootRef} className={styles.page}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerLinks}>
          ...
          <nav aria-label="资源页脚导航"><b>资源</b><a href={`${REPO_URL}#readme`} target="_blank" rel="noreferrer">使用文档</a><Link href="/about">版本说明</Link><a href={`${REPO_URL}/blob/main/docs/versions/CHANGELOG.md`} target="_blank" rel="noreferrer">更新记录</a><Link href="/design">品牌设计实验</Link></nav>
