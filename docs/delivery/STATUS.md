...
当前可运行代码仍是 `v1.6.0-rc.1`。v2 已完成通用个人知识工作台的产品/架构草案，以及通过验收的信息架构和 V5-P01～P14 原型；v2 业务代码尚未开始。测试策略、核心场景和夹具规范已形成草案，等待验收与自动化。

优化项目标准前的完整事实、进行中工作和未来目标，见 [v2 项目进度与未来目标交付检查点（2026-08-30）](V2_PROGRESS_CHECKPOINT_2026-08-30.md)。
