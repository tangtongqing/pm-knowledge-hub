...
> 对应需求：[PRD v5 草案](PRD-v5-DRAFT.md) · [指标 v2 草案](METRICS-v2-DRAFT.md) · 文档版本：`v3.0-draft.1` · 更新日期：2026-08-24 · 状态：评审草案
...
|---|---|---|---|---|
| M0 产品定义 | 团队对 v2 的对象、范围、风险和验收形成同一理解 | 原型和说明不再把 PM、Obsidian 或单目录写成用户边界 | 文档追踪覆盖率、关键决策关闭率 | 当前草案 |
...
- 解析、检索、引用、图谱和 Agent 测试策略；
- 版本化评测集结构、设备/规模口径和事件隐私规范。
...
*v3.0-draft.1：以个人知识闭环为主线，建立 M0～M5 结果门槛；取消任何“先 PM、后其他职业”的路线，并将团队知识库保持为独立 Future 研究。*
