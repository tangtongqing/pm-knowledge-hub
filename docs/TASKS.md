...
> **Sprint目标**：以混合路线完成 4 个产品设计 P1，并保留 P0 引擎承诺。
> **Sprint状态**：✅ v1.6.0-rc.1 发布门禁通过且已同步远程 `main`；尚未创建正式 tag/Release。
> **更新时间**：2026-07-22
...
（无开发项；等待产品负责人决定是否为 v1.6.0 创建正式 tag/Release，或启动 v1.7 P0。）

## ✅ 已完成

- [x] **[TASK-034]** 同步 v1.6 RC 远程发布事实：更新 README、CHANGELOG、进度、路线图与验收文档，明确候选代码已推送远程 `main`、最新稳定标签为 v1.5.0、v1.6.0 尚未正式发布 *(2026-07-22)*

- [x] **[TASK-033]** v1.6 产品设计 P1 收口：统一版本与发布事实；修复五页移动/桌面横向溢出和关键键盘路径；补齐引用摘录、锚点、图片、重试与删除撤销；保留 P0 并重排到 v1.7；lint、build、47 项 pytest 与双视口浏览器门禁全部通过 *(2026-07-16)*
