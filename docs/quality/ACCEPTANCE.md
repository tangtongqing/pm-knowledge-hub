...
> 文档导航：[文档中心](../README.md) · [当前状态](../delivery/STATUS.md) · [线上黑盒测试](web-test-2026-07-24/TEST_REPORT.md)
...
* **Action**: Run `git describe --tags` and check `docs/delivery/CHANGELOG.md`.
* **Expected Result**:
